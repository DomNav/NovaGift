...
export const PRESET_SKINS: Skin[] = [
  ...
  },
  {
    id: 'amethyst',
    name: 'Amethyst',
    settings: { angle: 24, noise: 0.1, stops: ['#B980FF', '#8733FF', '#6C28CC', '#E0C2FF'] },
    animation: 'none',
  },
  {
    id: 'vaporwave',
  ...
  },
  {
    id: 'emerald',
    name: 'Emerald',
    settings: { angle: 20, noise: 0.1, stops: ['#00D49A', '#00B37E', '#089E78', '#34F2B3'] },
    animation: 'none',
    requires: { minSends: 5 },
  },
  {
  ...
  },
  {
    id: 'solarFlare',
    name: 'Solar Flare',
    settings: { angle: 26, noise: 0.1, stops: ['#FFB703', '#FD632F', '#FF3D00', '#FFE5A5'] },
    animation: 'pulse',
